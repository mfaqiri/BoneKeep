...
/obj/item/weapon/sword/sabre/shalal
	...
	icon_state = "marlin"
	name = "shalal sabre"
	desc = "A fine weapon of Zyubuntu origin in the style of the Shalal tribesfolk, renowned for their defiance against magic and mastery of mounted swordsmanship."
	parrysound = "rapier"
	minstr = 6
	sellprice = 80
...
/obj/item/weapon/sword/scimitar
	...
	name = "scimitar"
	desc = "A Zyubuntu design for swords, these curved blades are a common sight in the lands of the Ziggurat."
	icon_state = "scimitar"
...
/obj/item/weapon/sword/long/rider
	...
	icon_state = "tabi"
	name = "kilij scimitar"
	desc = "A curved blade of Zyubuntu origin meaning 'curved one'. The standard sword that saw the conquest of the Zalad continent and peoples."
	sellprice = 80
...
/obj/item/weapon/sword/long/exe
	...
	desc = "An ancient blade of ginormous stature, with a round ended tip. The pride and joy of Osseus's greatest pastime, executions."
	minstr = 10
	slot_flags = ITEM_SLOT_BACK
