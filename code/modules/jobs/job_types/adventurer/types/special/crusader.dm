/datum/advclass/pilgrim/rare/crusader
	...
	You were sent to Osseus by the Order to get any and all assistance from the faithful for the Crusade."
...
/obj/item/clothing/cloak/cape/crusader
	name = "desert cape"
	desc = "Zyubuntu is known for it's legacies in tailoring, this particular cape is interwoven with fine stained silks and leather - a sand elf design, renown for it's style and durability."
