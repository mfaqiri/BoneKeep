/datum/advclass/mercenary/desert_pirate
	name = "Desert Rider"
	tutorial = "A pirate of rakshari origin, hailing from the wast dune-sea of Zyubuntu. Well trained riders and expirienced archers, these nomads live the life of marauders and raiders, taking what belongs to weaker settlements and caravans."
